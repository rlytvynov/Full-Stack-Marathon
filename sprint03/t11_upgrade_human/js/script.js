...
class Superhero extends Human {
    ...
    foto = 'assets/images/superhero.png';
    #flyTime = 10; //sec
    #fightTime = 3; //sec
...
function showHumman() {
    img.innerHTML = `<img class="big-img" id="big-img" src="${human.foto}"><div class="hungry-msg" id="hungry-msg">I'm HUNGRY!!</div><div class="sleep-title" id="sleep-img"><img class="sleep-img" src="assets/images/sleep.jpg"></div><div class="feed-title"><img class="sleep-img" src="assets/images/feed.gif"></div>`;
    let render = '';
